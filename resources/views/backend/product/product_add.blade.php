                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_name_fa" class="form-control"
                                                    required="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_tags_fa" class="form-control"
                                                    value="Lorem,Ipsum,Amet" data-role="tagsinput" required="">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_size_fa" class="form-control"
                                                    value="Small,Midium,Large" data-role="tagsinput" required="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_color_fa" class="form-control"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="short_descp_fa" id="textarea" class="form-control"
                                                    required placeholder="Textarea text"></textarea>
                                            </div>
                                        </div>
		...
		Long Description English
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea id="editor2" name="long_descp_fa" rows="10" cols="80">
		Long Description fadi
						</textarea>
                                            </div>
                                        </div>
                                ...
                                <div class="text-xs-right">
                                    <input type="submit" class="mb-5 btn btn-rounded btn-primary" value="Add Product">
                                </div>
                    </form>
