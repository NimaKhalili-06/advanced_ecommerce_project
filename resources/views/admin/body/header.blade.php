            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="waves-effect waves-light rounded dropdown-toggle p-0" data-toggle="dropdown"
                        ...
                        <img src="{{ asset($adminData->profile_photo_path) }}" alt="">
                    </a>
                    <ul class="dropdown-menu animated flipInX">
                        <li class="user-body">
                            <a class="dropdown-item" href="{{ url('admin/profile') }}"><i
                                    class="ti-user text-muted mr-2"></i> Profile</a>
                            <a class="dropdown-item" href="{{url('admin/change/password')}}"><i class="ti-wallet text-muted mr-2"></i>Change password</a>
