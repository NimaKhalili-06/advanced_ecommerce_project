        ...
        <div class="container">
            <div class="row">
                ...
                @php
                    ...
                    $categories = \App\Models\Category::orderBy('category_name_fa')->get();
                            ...
                            <ul class="nav">
                                @foreach($categories as $category)
                                    ...
                                    <li class="dropdown menu-item"><a href="#" class="dropdown-toggle"
                                                ...
                                                aria-hidden="true"></i>{{session()->get('language')=="persian"?$category->category_name_fa:$category->category_name_en}}
                                        </a>
                                        @php
                                            if(session()->get('language') == 'persian'){
                                                $subCategories = \App\Models\SubCategory::where('category_id',$category->id)->orderBy('subcategory_name_fa')->get();
                                        }else{
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 col-md-3">
                                                            <ul class="links list-unstyled">
                                                                <h2 class="title">{{session()->get('language')=='persian'?$subCategory->subcategory_name_fa:$subCategory->subcategory_name_en}}</h2>
                                                                @php
                                                                    if(session()->get('language') == 'persian'){
                        $subSubCategories = \App\Models\SubSubCategory::where('subcategory_id',$subCategory->id)->orderBy('subsubcategory_name_fa')->get();
    }else{
                                $subSubCategories = \App\Models\SubSubCategory::where('subcategory_id',$subCategory->id)->orderBy('subsubcategory_name_en')->get();
                                                                ...
                                                                @foreach($subSubCategories as $subSubCategory)
                                                                    <li>
                                                                        <a href="#">{{ session()->get('language')=='persian'?$subSubCategory->subsubcategory_name_fa:$subSubCategory->subsubcategory_name_en}}</a>
                                                                    </li>
                                                                @endforeach
                                                            </ul>
                                                        </div>
                        ...
                        <div class="more-info-tab clearfix ">
                            ...
                            <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                                <li class="active"><a data-transition-type="backSlide" href="#all"
                                                      data-toggle="tab">{{session()->get('language')=='persian'?"همه":"All"}}</a>
                                </li>
                                @php
                                    if(session()->get('language')=='persian') {
                                ...
                                @foreach($categories as $category)
                                    <li>
                                        <a data-transition-type="backSlide" href="#category{{$category->id}}"
                                           ...
                                           data-toggle="tab">{{session()->get('language')=='persian'?$category->category_name_fa:$category->category_name_en}}</a>
                                    </li>
                                @endforeach
                            ...
                            <div class="tab-pane in active" id="all">
                                <div class="product-slider">
                                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                                        @php
                                            $products = \App\Models\Product::where('status',1)->latest()->get();
                                        @endphp
...
@if($product->discount_price == NULL)
                                                            ...
                                                            @else
                                                               <div class="tag hot"><span>{{$product->discount_price/$product->selling_price*100}}%</span></div>
                                                        ...
                                                        <div class="product-info text-left">
                                                            <h3 class="name"><a
                                                                    href="detail.html">{{ session()->get('language') == 'persian' ? $product->product_name_fa : $product->product_name_en }}</a>
                                                            </h3>
                                                            <div class="rating rateit-small"></div>
                                                            ...
                                                            <div
                                                                ...
                                                                @else
                                                                    <span
                                                                        class="price">$ {{ $product->selling_price - $product->discount_price }}</span>
                                ...
                                <div class="tab-pane" id="category{{ $category->id }}">
                                    <div class="product-slider">
                                        <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                                            @php
                                                $categorizedProducts = \App\Models\Product::where('category_id',$category->id)->latest()->limit(6)->get();

                                            @endphp
                                            @forelse($categorizedProducts as $item)
                                                <div class="item item-carousel">
                                                    <div class="products">
                                                        <div class="product">
                                                            <div class="product-image">
                                                                <div class="image"><a href="detail.html"><img
                                                                            ...
                                                                            alt=""></a></div>
                                                                <!-- /.image -->@if($item->discount_price == NULL)
                                                                    <div class="tag new"><span>new</span></div>
                                                                @else
                                                                                                                              <div class="tag hot"><span>{{$item->discount_price/$item->selling_price*100}}%</span></div>
                                                            ...
                                                            <div class="product-info text-left">
                                                                <h3 class="name"><a
                                                                        href="detail.html">{{ session()->get('language') == "persian"?$item->product_name_fa:$item->product_name_en }}</a>
                                                                </h3>
                                                                <div class="rating rateit-small"></div>
                                                                <div class="description"></div>
                                                                <div class="product-price">
                                                                    ...
                                                                    @else
                                                                        <span
                                                                            class="price">$ {{ $item->selling_price - $item->discount_price }}</span>
